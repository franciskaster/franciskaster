...
Eu sou Francis Kaster. Gosto de automação, programação web, programação de baixo nível e IoT, e atualmente curso Engenharia Eletrônica.

## O que eu ando fazendo ?

- **Automação:** Estou criando um sistema de irrigação open source.
- **Programação Web:** Faço sistemas e sites, atualmente uso Django e Vue. Priorizo acessibilidade e performance nas páginas que faço
- **IoT:** Faço integração de microcontroladores com sistemas de controle via internet, normalmente utilizo Esp32 ou Esp8266.
